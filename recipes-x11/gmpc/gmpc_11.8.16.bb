...
DEPENDS = "glib-2.0 glib-2.0-native gettext-native gettext libmpd libsoup-2.4 sqlite libice libsm libx11 gtk+ intltool-native libunique gob2-native xserver-xorg"
