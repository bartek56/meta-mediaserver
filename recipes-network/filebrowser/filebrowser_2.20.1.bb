...
SRC_URI_arm="https://github.com/filebrowser/filebrowser/releases/download/v${PV}/linux-armv7-filebrowser.tar.gz \
         file://filebrowser.service"

SRC_URI_aarch64="https://github.com/filebrowser/filebrowser/releases/download/v${PV}/linux-arm64-filebrowser.tar.gz \
         file://filebrowser.service"

S = "${WORKDIR}"

SHA_CHECKSUM_arm = "87451de51f2b230a095225c450a846da48c4f7589c2524cb8b4693a215ad3dff"
SHA_CHECKSUM_aarch64 = "b375cbc2e47ae5159d4cebcae82b2e11070e153efd819cf03d08531572ed46f3"
